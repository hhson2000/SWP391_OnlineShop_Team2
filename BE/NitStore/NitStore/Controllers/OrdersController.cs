...
namespace NitStore.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CustomerId,Status,CreateDate,UpdatedDate,Total")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CustomerId,Status,CreateDate,UpdatedDate,Total")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
